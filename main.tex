...
\newcommand{\program}[2]{\construct{\keyword{program} ~ #1 ~ #2}}
...
\newcommand{\builtinIntegerType}[1]{\keyword{integer}}
\newcommand{\builtinBytestringType}[1]{\keyword{bytestring}}
\newcommand{\builtinSizeType}[1]{\keyword{size}}
\newcommand{\builtinT}[1]{\construct{\keyword{builtin} ~ #1}}
