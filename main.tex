...
The syntax of the language is presented in section 1, and section 2 describes a bidirectional typechecking algorithm for the language \cite{pfenning-bidi}\cite{christiansen-bidi}. Section 3 describes the operational semantics of the language in two ways: A sequent calculus of $\beta$-reduction, and rules for a CK machine \cite{felleisen-friedman}. The former is perhaps more suited to formal reasoning about Plutus Core, with the latter more suited to efficient implementations. Section 4 describes the prmitive terms and types of the language, and finally section 5 contains a number of examples.
