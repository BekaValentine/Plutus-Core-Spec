...
\newcommand{\builtinIntegerType}[1]{\keyword{integer[}#1\keyword{]}}
\newcommand{\builtinBytestringType}[1]{\keyword{bytestring[}#1\keyword{]}}
\newcommand{\builtinSizeType}{\keyword{size}}
