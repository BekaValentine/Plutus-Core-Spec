...
\begin{figure*}[t]
    ...
    \begin{prooftree}
        \AxiomC{\(\hypJ{\Gamma, \termJ{x}{S}}{\istermJ{M}{S}}\)}
        \RightLabel{fix}
        \UnaryInfC{\(\hypJ{\Gamma}{\istermJ{\fix{x}{S}{M}}{S}}\)}
    \end{prooftree}
    ...
    \begin{prooftree}
        ...
        \RightLabel{inst}
        \BinaryInfC{\(\hypJ{\Gamma}{\istermJ{\inst{L}{T}}{\subst{T}{\alpha}{S}}}\)}
    \end{prooftree}
    
    \begin{prooftree}
        \alwaysNoLine
        \AxiomC{\(\hypJ{\Gamma, \typeJ{\alpha}{\typeK{}}}{\istypeJ{S}{\typeK{}}}\)}
        \UnaryInfC{\(\hypJ{\Gamma}{\istermJ{M}{\subst{\fixT{\alpha}{S}}{\alpha}{S}}}\)}
        \alwaysSingleLine
        \RightLabel{wrap}
    ...
    \begin{prooftree}
        ...
        \RightLabel{unwrap}
        \UnaryInfC{\(\hypJ{\Gamma}{\istermJ{\unwrap{M}}{\subst{\fixT{\alpha}{S}}{\alpha}{S}}}\)}
    \end{prooftree}
    ...
    \begin{prooftree}
        ...
        \RightLabel{builtin}
        \UnaryInfC{\(\hypJ{\Gamma}{\istermJ{\con{bi}}{S}}\)}
    \end{prooftree}
