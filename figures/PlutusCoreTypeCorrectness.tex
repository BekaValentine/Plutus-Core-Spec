...
\begin{figure*}[t]
    ...
    \begin{prooftree}
        ...
        \RightLabel{tyforall}
        \UnaryInfC{\(\hypJ{\Gamma}{\istypeJ{\allT{\alpha}{K}{T}}{\typeK{}}}\)}
    \end{prooftree}
...
\begin{figure*}[t]
    ...
    \begin{prooftree}
        ...
        \RightLabel{abs}
        \UnaryInfC{\(\hypJ{\Gamma}{\checkJ{\allT{\alpha}{K}{T}}{\abs{\alpha}{M}}}\)}
    \end{prooftree}
...
\begin{figure*}[t]
    ...
    \begin{prooftree}
        \alwaysNoLine
        \AxiomC{\(\hypJ{\Gamma}{\synthJ{M}{\allT{\alpha}{K}{T}}}\)}
    ...
    \begin{prooftree}
        \AxiomC{$bi$ is $T$}
        \RightLabel{builtin}
        \UnaryInfC{\(\hypJ{\Gamma}{\synthJ{\con{bi}}{T}}\)}
    \end{prooftree}
