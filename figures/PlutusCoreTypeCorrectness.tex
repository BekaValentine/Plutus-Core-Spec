...
\begin{figure*}[t]
    ...
    \begin{prooftree}
        \AxiomC{$bt$ has kind $K$ in Fig. \ref{Plutus_core_builtins}}
...
\begin{figure*}[t]
    ...
    \begin{prooftree}
        ...
        \UnaryInfC{\(K = \typeK{}\)}
        \UnaryInfC{\(\hypJ{\Gamma}{\istermJ{M}{\subst{\fix{\alpha}{\typeK{}}{A}}{\alpha}{A}}}\)}
        \alwaysSingleLine
        \RightLabel{wrap}
        \UnaryInfC{\(\hypJ{\Gamma}{\istermJ{\wrap{\alpha}{A}{M}}{\fix{\alpha}{\typeK{}}{A}}}\)}
    \end{prooftree}
    
    \begin{prooftree}
        \AxiomC{\(\hypJ{\Gamma}{\istermJ{M}{\fix{\alpha}{\typeK{}}{A}}}\)}
        \RightLabel{unwrap}
        \UnaryInfC{\(\hypJ{\Gamma}{\istermJ{\unwrap{M}}{\subst{\fix{\alpha}{\typeK{}}{A}}{\alpha}{A}}}\)}
    \end{prooftree}
    ...
    \begin{prooftree}
        \AxiomC{$bi$ has type $A$ in Fig. \ref{Plutus_core_builtins}}
        \RightLabel{builtin}
