...
\begin{figure*}[t]
    ...
    \begin{prooftree}
        \AxiomC{\(\hypJ{\Gamma, \termJ{x}{\recT{S}}}{\istermJ{M}{S}}\)}
        \RightLabel{fix}
        \UnaryInfC{\(\hypJ{\Gamma}{\istermJ{\fix{x}{S}{M}}{\recT{S}}}\)}
    \end{prooftree}
    
    \begin{prooftree}
        \AxiomC{\(\hypJ{\Gamma}{\istermJ{M}{\recT{S}}}\)}
        \RightLabel{run}
        \UnaryInfC{\(\hypJ{\Gamma}{\istermJ{\run{M}}{S}}\)}
    \end{prooftree}
