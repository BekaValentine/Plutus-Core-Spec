...
\begin{figure*}[t]
    ...
    \hspace{-35em}\(\begin{array}{lllll}
        ...
        \texttt{quotientInteger}   &  \forall s :: size.\ integer_s \to integer_s \to integer_s  &  s!i_0 , s!i_1   & s!(\operatorname{quot}\ i_0\ i_1)                    & i_1 \not= 0\\
        \texttt{remainderInteger}  &  \forall s :: size.\ integer_s \to integer_s \to integer_s  &  s!i_0 , s!i_1   & s!(\operatorname{rem} \ i_0 \ i_1)                     & i_1 \not= 0\\
        \texttt{modInteger}        &  \forall s :: size.\ integer_s \to integer_s \to integer_s  &  s!i_0 , s!i_1   & s!(\operatorname{mod} \ i_0 \ i_1)                     & i_1 \not= 0\\
        %&&\\
