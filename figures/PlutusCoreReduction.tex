...
\begin{figure*}[t]
    \centering
    \[\begin{array}{lrclr}
        \textrm{Frame} & f & ::= & \inInstLeft{\_}{A}                     & \textrm{left instantiation}\\
                       &   &     & \inInstRight{V}{\_}                    & \textrm{right instantiation}\\
                       &   &     & \inAppLeft{\_}{M}                      & \textrm{left app}\\
                       &   &     & \inAppRight{V}{\_}                     & \textrm{right app}\\
    \end{array}\]
...
\begin{figure*}[t]
    ...
    \begin{prooftree}
        \AxiomC{\(\step{M}{\error{A}}\)}
        \UnaryInfC{\(\step{\ctxsubst{f}{M}}{\error{A}}\)}
    \end{prooftree}
...
\begin{figure*}[t]
    ...
    \begin{align*}
        ...
        &\cksteps{\ckbackward{s, \inInstRightFrame{\abs{\alpha}{K}{M}}{\_}}{S}}{\ckforward{s}{\subst{S}{\alpha}{M}}}\\
